package com.minatogithuborg.secretreplacementone;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithuborg.secretreplacementone"})
@EnableCaching
...
public class SecretReplacementOneApplication {

	public static void main(String[] args) {
		SpringApplication.run(SecretReplacementOneApplication.class, args);
	}
